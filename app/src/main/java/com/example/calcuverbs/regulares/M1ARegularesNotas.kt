...
@Composable
fun NoteRegularScreen(
    viewModel: NoteViewModel,
    navController: NavController,
    noteIndex: Int // Identificador de la nota regular
) {
    ...
    Scaffold(
        ...
        content = { innerPadding ->
            Column(
                ...
                OutlinedTextField(
                    value = noteContent, // Valor de la nota
                    ...
                    colors = TextFieldDefaults.outlinedTextFieldColors(
                        ...
                        focusedBorderColor = RegularesSecondary, // Color del borde enfocado
                        unfocusedBorderColor = Color.Gray, // Color del borde desenfocado
                        cursorColor = RegularesSecondary, // Color del cursor
                        focusedLabelColor = RegularesTertiary, // Color del label enfocado
                        unfocusedLabelColor = RegularesTertiary // Color del label desenfocado
                    )
                )
            }
        }
